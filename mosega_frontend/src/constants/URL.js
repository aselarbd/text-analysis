export const ADD_NEW_POLICY = '/PrivacyPolicyAPI/api/v1/policy';
export const GET_ONE_POLICY = '/PrivacyPolicyAPI/api/v1/policy/';
export const GET_ALL_POLICIES = '/PrivacyPolicyAPI/api/v1/policy';
